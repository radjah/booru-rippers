...
## get.xbooru.sh ##
Качалка для сайта [https://xbooru.com/](https://xbooru.com/).

**Использование:**
> get.xbooru.sh набор\_тегов [каталог\_для\_сохранения]
...
## get.wallhaven.sh ##
Качалка для сайта [https://wallhaven.cc/](https://wallhaven.cc/).

**Использование:**
> get.wallhaven.sh набор\_тегов [каталог\_для\_сохранения]
...
id\_автора - значение параметра "id" в URL вида "https://www.pixiv.net/en/users/12345/artworks" или "https://www.pixiv.net/en/users/12345"
